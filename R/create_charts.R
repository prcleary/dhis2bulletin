...
create_charts <- function(params) {
  ...
  create_chart1(data1, plotfilename = 'figs/fig1plot.png', plotxlabel = 'ISO week', plotylabel = 'Notifications', plotsubtitle = 'Distribution of IDSR Priority Diseases Reported during last 4 weeks from Reporting Districts of Pakistan')
  ...
  create_chart1(data2, plotfilename = 'figs/fig2plot.png', plotxlabel = 'ISO week', plotylabel = 'Notifications', plotsubtitle = 'Frequency of IDSR Priority Diseases Reported during last 4 weeks from Azad Jammu & Kashmir (Mirpur)')
  ...
  create_chart1(data3, plotfilename = 'figs/fig3plot.png', plotxlabel = 'ISO week', plotylabel = 'Notifications', plotsubtitle = 'Frequency of IDSR Priority Diseases Reported during last 4 weeks from Baluchistan (Gwader, Kech & Killa Abdullah)')
  ...
  create_chart1(data4, plotfilename = 'figs/fig4plot.png', plotxlabel = 'ISO week', plotylabel = 'Notifications', plotsubtitle = 'Frequency of IDSR Priority Diseases Reported during last 4 weeks from Khyber Pakhtunkhwa (Haripur & Lakki Marwat)')
  ...
  create_chart1(data5, plotfilename = 'figs/fig5plot.png', plotxlabel = 'ISO week', plotylabel = 'Notifications', plotsubtitle = 'Frequency of IDSR Priority Diseases Reported during last 4 weeks from Gilgit Baltistan (Hunza)')
  ...
  create_chart1(data6, plotfilename = 'figs/fig6plot.png', plotxlabel = 'ISO week', plotylabel = 'Notifications', plotsubtitle = 'Frequency of IDSR Priority Diseases Reported during last 4 weeks from Islamabad (ICT HF)')
